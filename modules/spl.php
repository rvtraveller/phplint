...
/** Standard PHP Library (SPL) Functions.
	...
	This module is always available in PHP, but PHPLint holds it in a
...
implements ArrayAccess, SeekableIterator, Countable, Serializable
{
	...
	/*. void  .*/ function setFlags(/*. string .*/ $flags){}
...
class SplFileInfo
{
	...
	/*. mixed .*/ function _bad_state_ex(/*. args .*/){}
...
implements RecursiveIterator, SeekableIterator
{
	...
	public /*. int .*/ function fputcsv(/*. array .*/ $fields, $delimiter = ",", $enclosure = '"', $escape = "\\"){}
	...
	/** @deprecated Not documented in the manual. */
	public /*. mixed .*/ function getCurrentLine(/*. args .*/){}
}
...
/**
 * @deprecated Do not use this class because it depends on the simplexml module
 * which is deprecated under PHPLint. This declaration is only an incomplete
 * stub just to display this message whenever this class gets used somewhere.
 */
class SimpleXMLIterator
//extends SimpleXMLElement // here is where it depends on simplexml
...
implements Iterator, Countable
{
	...
	/** @deprecated Still not documented in the manual. */
	/*. mixed .*/ function isCorrupted(/*. args .*/){}
}
...
/*. array  .*/ function class_uses(/*. mixed .*/ $class_, $autoload = true){}

/**
 * Closures, better known as anonymous functions, are not supported by PHPLint.
 */
class Closure {
	private function __construct(){}
	public static /*. Closure .*/ function bind(/*. Closure .*/ $closure, /*. object .*/ $newthis, /*. mixed .*/ $newscope = "static"){}
	public /*. Closure .*/ function bindTo(/*. object .*/ $newthis, /*. mixed .*/ $newscope = "static"){}

/*. if_php_ver_7 .*/
	public /*. mixed .*/ function call(/*. object .*/ $newthis, /*. mixed .*/... $arguments){}
/*. end_if_php_ver .*/

}

/**
 * Generators are not supported by PHPLint. This exception seems to be defined
 * in the engine, but it is not documented in the manual.
 */
class ClosedGeneratorException extends Exception {}

/**
 * Generators are not supported by PHPLint.
 */
class Generator implements Iterator {
	public /*. mixed .*/ function current(){}
/*. if_php_ver_7 .*/
	public /*. mixed .*/ function getReturn(){}
/*. end_if_php_ver .*/
	public /*. mixed .*/ function key(){}
	public /*. void  .*/ function next(){}
	public /*. void  .*/ function rewind(){}
	public /*. mixed .*/ function send(/*. mixed .*/ $value){}
	/**  Method name throw() is not valid under PHPLint.  */
	public /*. mixed .*/ function throw_FIXME(/*. Exception .*/ $exception){}
	public /*. bool  .*/ function valid(){}
	public /*. void  .*/ function __wakeup(){}
}

class CallbackFilterIterator extends FilterIterator {
	public /*. void .*/ function __construct(/*. Iterator .*/ $iterator, /*. mixed .*/ $callback){}
	public /*. string .*/ function accept(){}
}
...
class InfiniteIterator extends IteratorIterator {
	public /*. void .*/ function __construct(/*. Iterator .*/ $iterator){}
	public /*. void .*/ function next(){}
}
...
class MultipleIterator implements Iterator {
	...
	public /*. void .*/ function __construct($flags = 1){}
	public /*. void .*/ function attachIterator(/*. Iterator .*/ $iterator, /*. string .*/ $infos = NULL){}
	public /*. void .*/ function containsIterator(/*. Iterator .*/ $iterator){}
	public /*. void .*/ function countIterators(){}
	public /*. array .*/ function current(){}
	public /*. void .*/ function detachIterator(/*. Iterator .*/ $iterator){}
	public /*. void .*/ function getFlags(){}
	public /*. array .*/ function key(){}
	public /*. void .*/ function next(){}
	public /*. void .*/ function rewind(){}
	public /*. void .*/ function setFlags(/*. int .*/ $flags){}
	public /*. bool .*/ function valid(){}
...
public /*. void .*/ function __construct(/*. RecursiveIterator .*/ $iterator, /*. string .*/ $callback){}
public /*. RecursiveCallbackFilterIterator .*/ function getChildren(){}
public /*. bool .*/ function hasChildren(){}
}
...
class RecursiveTreeIterator extends RecursiveIteratorIterator {
	...
	public /*. void .*/ function beginChildren(){}
	public /*. RecursiveIterator .*/ function beginIteration(){}
	public /*. RecursiveIterator .*/ function callGetChildren(){}
	public /*. bool .*/ function callHasChildren(){}
	...
	public /*. void .*/ function endChildren(){}
	public /*. void .*/ function endIteration(){}
	public /*. string .*/ function getEntry(){}
	public /*. void .*/ function getPostfix(){}
	public /*. string .*/ function getPrefix(){}
	public /*. string .*/ function key(){}
	public /*. void .*/ function next(){}
	public /*. void .*/ function nextElement(){}
	public /*. void .*/ function rewind(){}
	public /*. void .*/ function setPrefixPart(/*. int .*/ $part, /*. string .*/ $value){}
	public /*. bool .*/ function valid(){}
}
