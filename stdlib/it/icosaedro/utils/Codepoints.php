...
/*. require_module 'core'; require_module 'array'; .*/

/**
 * Unicode codepoints case conversion and case-folding.
 * 
...
/**
 * Maps the codepoint to its upper-case counterpart.
 * @param int $cp Codepoint in [0,65535].
 * @return int Corresponding upper-case codepoint.
 */
static function toUpperCase($cp)
{
	// From UnicodeData.txt, maps fields 0 => 13 for "Lu" entries,
	...
	0x01bd => 0x01bc, 0x01bf => 0x01f7, 0x01c6 => 0x01c4, 0x01c9 => 0x01c7,
	...
	0x0260 => 0x0193, 0x0263 => 0x0194, 0x0265 => 0xa78d, 0x0266 => 0xa7aa,
	0x0268 => 0x0197, 0x0269 => 0x0196, 0x026b => 0x2c62, 0x026f => 0x019c,
	...
	0x0523 => 0x0522, 0x0525 => 0x0524, 0x0527 => 0x0526, 0x0561 => 0x0531,
	...
	0x0586 => 0x0556, 0x1d79 => 0xa77d, 0x1d7d => 0x2c63, 0x1e01 => 0x1e00,
	...
	0x214e => 0x2132, 0x2184 => 0x2183, 0x2c30 => 0x2c00, 0x2c31 => 0x2c01,
	...
	0xa697 => 0xa696, 0xa723 => 0xa722, 0xa725 => 0xa724, 0xa727 => 0xa726,
	...
	0xa793 => 0xa792, 0xa7a1 => 0xa7a0, 0xa7a3 => 0xa7a2, 0xa7a5 => 0xa7a4,
	0xa7a7 => 0xa7a6, 0xa7a9 => 0xa7a8, 0xff41 => 0xff21, 0xff42 => 0xff22,
	...
	if( array_key_exists($cp, $lowercase) )
		return $lowercase[$cp];
	else
		return $cp;
}
...
/**
 * Maps the codepoint to its lower-case counterpart.
 * @param int $cp Codepoint in [0,65535].
 * @return int Corresponding lower-case codepoint.
 */
...
/**
 * Maps the codepoint to a case-folded value suitable for case-insensitive
 * comparison. For the latin charset, this means that upper-case letters
 * are mapped in their lower-case counterparts.
 * @param int $cp Codepoint in [0,65535].
 * @return int Case-folded codepoint.
 */
static function toFoldCase($cp)
{
	// From CaseFolding.txt, maps fields 0 => 2 for C and S entries,
	// see http://www.unicode.org/reports/tr21/tr21-5.html
	static $casefold = array(
	0x0041 => 0x0061, 0x0042 => 0x0062, 0x0043 => 0x0063, 0x0044 => 0x0064,
	0x0045 => 0x0065, 0x0046 => 0x0066, 0x0047 => 0x0067, 0x0048 => 0x0068,
	0x0049 => 0x0069, 0x004a => 0x006a, 0x004b => 0x006b, 0x004c => 0x006c,
	0x004d => 0x006d, 0x004e => 0x006e, 0x004f => 0x006f, 0x0050 => 0x0070,
	...
	0x0370 => 0x0371, 0x0372 => 0x0373, 0x0376 => 0x0377, 0x0386 => 0x03ac,
	0x0388 => 0x03ad, 0x0389 => 0x03ae, 0x038a => 0x03af, 0x038c => 0x03cc,
	0x038e => 0x03cd, 0x038f => 0x03ce, 0x0391 => 0x03b1, 0x0392 => 0x03b2,
	...
	0x03c2 => 0x03c3, 0x03cf => 0x03d7, 0x03d0 => 0x03b2, 0x03d1 => 0x03b8,
	0x03d5 => 0x03c6, 0x03d6 => 0x03c0, 0x03d8 => 0x03d9, 0x03da => 0x03db,
	0x03dc => 0x03dd, 0x03de => 0x03df, 0x03e0 => 0x03e1, 0x03e2 => 0x03e3,
	0x03e4 => 0x03e5, 0x03e6 => 0x03e7, 0x03e8 => 0x03e9, 0x03ea => 0x03eb,
	0x03ec => 0x03ed, 0x03ee => 0x03ef, 0x03f0 => 0x03ba, 0x03f1 => 0x03c1,
	0x03f4 => 0x03b8, 0x03f5 => 0x03b5, 0x03f7 => 0x03f8, 0x03f9 => 0x03f2,
	...
	0x04c0 => 0x04cf, 0x04c1 => 0x04c2, 0x04c3 => 0x04c4, 0x04c5 => 0x04c6,
	...
	0x10c7 => 0x2d27, 0x10cd => 0x2d2d, 0x1e00 => 0x1e01, 0x1e02 => 0x1e03,
	...
	0x1e94 => 0x1e95, 0x1e9b => 0x1e61, 0x1e9e => 0x00df, 0x1ea0 => 0x1ea1,
	...
	0xa696 => 0xa697, 0xa722 => 0xa723, 0xa724 => 0xa725, 0xa726 => 0xa727,
	...
	0xa78d => 0x0265, 0xa790 => 0xa791, 0xa792 => 0xa793, 0xa7a0 => 0xa7a1,
	0xa7a2 => 0xa7a3, 0xa7a4 => 0xa7a5, 0xa7a6 => 0xa7a7, 0xa7a8 => 0xa7a9,
	0xa7aa => 0x0266, 0xff21 => 0xff41, 0xff22 => 0xff42, 0xff23 => 0xff43,
	...
	if( array_key_exists($cp, $casefold) )
		return $casefold[$cp];
	else
		return $cp;
}
