...
/*. forward private final class UMatchedGroup implements UGroup {
...
/*. private .*/ final class UMatchedElement implements UElement {
	...
	public function __toString() {
		return $this->pe->__toString();
	}
	
	
	public function toUString() {
		return UString::fromUTF8($this->pe->__toString());
	}
...
/*. private .*/ final class UMatchedGroup implements UGroup {
	...
	public function __toString() {
		return $this->pg->__toString();
	}
	
	
	public function toUString() {
		return UString::fromUTF8($this->pg->__toString());
	}
...
class UPattern implements UElement, Printable {
	...
	public function elem0(){
		return new UMatchedElement($this->subject, $this->p->elem0());
	}
	...
	/**
	 * Returns this pattern in canonicized, ASCII form.
	 * @return UString This pattern in canonicized, ASCII form.
	 */
	function toUString(){
		return UString::fromUTF8($this->p->__toString());
	}
