...
# Version: $Date: 2016/03/06 13:19:37 $
# Copyright 2007-2016 by icosaedro.it di Umberto Salsi
...
entry $f.v -textvariable opts(php_cli) -background white -width 50
